...
export const PROTOCOL = `variant:`;

export class VariantRemapResolver implements Resolver {
  ...
  supportsLocator(locator: Locator, opts: MinimalResolveOptions) {
    // Once transformed into locators, the descriptors are resolved by the variant's resolver
    return false;
  }
